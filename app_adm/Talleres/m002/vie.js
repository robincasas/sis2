  ...
  $("#mxcurso1").click(function(){
    if($("#all").val()!=null){
      ...
      for (var i = 0; i < mystr.length; i++) {
        ...
        $("#mxcurso2").append("<tr><td>"+mystr[i]+"</td><td><input class='cxp' type='text' size='3' data-cod='"+myarr[0]+"' name=cxp["+myarr[0]+"]></td></tr>") ;
      }
      $("#mxcurso2").append("</table>");
      $("#nomcur").html("TALLERES POR PAQUETES:");
      $("#monto").val("---");
    }
    else{
      $("#mxcurso2").html("");
          ...
          $.ajax({
            ...
            success: function(r){
              if (r.exito==1){
                ...
                //window.open('app_adm/Reportes/recibo_pago.php?id_pago='+r.numrec+'&'+$(".cxp").serialize());
                window.open('app_adm/Reportes/recibo_pago.php?id_pago='+r.numrec+'&paquete='+r.paquete);                
