...
switch ($_REQUEST["evento"]) {
  ...
  case "new_alu" :
    ...
    break;
  case "ins_alu" :  //matricular
    $biz->ins_alu($_REQUEST['idalumno'], $_REQUEST['fecpag'], $_REQUEST['idprograma'], $_REQUEST['partes'], $_REQUEST['canti'], $_REQUEST['resta'],$_REQUEST['obs'],$_REQUEST['monhid'],$_REQUEST['codcurs'],$_REQUEST['cxp']);
    break;
